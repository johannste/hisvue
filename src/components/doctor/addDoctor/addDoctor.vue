    ...
    <div class="addDoctor">
      ...
      <el-form ref="form" :model="form" :rules="rules" label-width="80px" class="addForm">
        ...
        <el-form-item label="性别" prop="gender">
          <el-radio class="radio" v-model="form.gender" label="male">男</el-radio>
          <el-radio class="radio" v-model="form.gender" label="female">女</el-radio>
        </el-form-item>
        ...
        <el-form-item label="专家与否" prop="isexpert">
          <el-input v-model="form.isexpert"></el-input>
        </el-form-item>
      ...
      data () {
        return {
          ...
          rules: {
            ...
            isexpert: [
              { required: true, message: '请填写专家与否', trigger: 'blur' }
            ]
          }
        };
      },
