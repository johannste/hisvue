    ...
    <div class="app-body">
      <div class="menu" :class="{ smallNav: isCollapse }">
        <el-menu default-active="1-4-1" class="el-menu-vertical-demo"  :collapse="isCollapse"  theme="dark">
          ...
          <el-submenu index="4" v-if="type === '01' || type === '04' || type === '10'">
            <template slot="title">
          ...
          <el-submenu index="7" v-if="type === '01' || type === '04'">
            <template slot="title">
              <i class="icon-nurse"></i>
              <span slot="title">患者管理系统</span>
            </template>
            <el-menu-item-group>
              <el-menu-item index="7-1"><router-link to="addPatient">建立患者档案</router-link></el-menu-item>
              ...
              <el-menu-item index="7-4"><router-link to="addHospitalized">建立住院患者档案</router-link></el-menu-item>
            </el-menu-item-group>
          </el-submenu>
          <el-submenu index="8" v-if="type === '01'">
            <template slot="title">
